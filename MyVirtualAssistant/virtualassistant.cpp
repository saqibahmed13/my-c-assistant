...
void wishme(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Saqib"<<endl;
        string phrase = "Good Morning Saqib";
        ...
        cout<< "Good Afternoon Saqib"<<endl;
        string phrase = "Good Afternoon Saqib";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Saqib"<<endl;
        string phrase = "Good Evening Saqib";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(strcmp(password, "saqib")==0){
            cout<<"\n<==================================================================================================>\n\n";
            wishme();
            do{
                cout<<"\n<==================================================================================================>\n\n";
                cout<<endl<<"How can i help you Saqib sir...."<<endl<<endl;

                string phrase = "How can i help you Saqib sir";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my master VirtualSaqib !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master VirtualSaqib";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
